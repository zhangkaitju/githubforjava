...
import static cn.edu.tju.http.URLsDecoder.encodeURL;
...
import cn.edu.tju.entity.Commit;
import cn.edu.tju.entity.Contributor;
import cn.edu.tju.entity.Issue;
import cn.edu.tju.entity.IssueLabel;
import cn.edu.tju.entity.Language;
import cn.edu.tju.entity.Milestone;
import cn.edu.tju.entity.MyException;
import cn.edu.tju.entity.Project;
import cn.edu.tju.entity.Release;
import cn.edu.tju.entity.User;
import cn.edu.tju.http.HttpModule;
import cn.edu.tju.http.Requests;
import cn.edu.tju.search.UrlBuilder.GithubAPI;
	...
	public List<Language> getTopMostUsedLanguagesLoc(List<Project> projects, int limit){
		...
		for (Project project: projects){
			if (project.getLanguages() == null) {
				throw new MyException("languages information required");
			}
